...
class _GroupsScreenState extends State<GroupsScreen> {
  ...
  Future<void> _loadGroups() async {
    ...
    setState(() {
      ...
      groups = allGroups.where((group) {
        final status = group.getGroupStatus(); // Assuming you have a default member
  ...
  List<Group> getSettledGroups() {
    return ExpenseManagerService.getAllGroups().where((group) {
      final status = group.getGroupStatus(); // Assuming default member
            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final status = group.getGroupStatus();
                  return status == "Settled" || status == "No Expense"
                      ? SizedBox.shrink()
