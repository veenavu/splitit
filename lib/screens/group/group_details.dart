...
import 'gruop_binding/groupsettings_binding.dart';
    ...
    return Scaffold(
      appBar: GroupDetailsAppBar(
        ...
        onSettingsTap: () {
          ...
          // );
          Get.to(
                () => GroupSettings(group: widget.groupItem),
            binding: GroupSettingsBinding(widget.groupItem),
          );
        },
      ),
            ...
            child: ListView.builder(
              ...
              itemBuilder: (context, index) {
                ...
                return ExpenseListItem(
                  ...
                  onTap: () {
                    expenseController.onExpenseSelected(expenses[reversedIndex]);
                    _navigateToExpenseDisplay(() {
                      getAllExpenses();
                    });
                  },
                  onLongPress: () => _showDeleteDialog(expenses[reversedIndex]),
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Get.to(() => AddExpensePage(group: widget.groupItem));
        },
