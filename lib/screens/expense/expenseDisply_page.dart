...
class _ExpenseDisplayPageState extends State<ExpenseDisplayPage> {
  ...
  void initState() {
    ...
    // Listen to both groups and profile updates
    ever(expenseController.groups, (_) => _updateExpense());
    // Add a listener for the dashboard controller's profile updates
    final dashboardController = Get.find<DashboardController>();
    ever(dashboardController.userProfile, (_) => _updateExpense());
  }
  void _updateExpense() {
    if (mounted) {
      setState(() {
        // Fetch the latest version of the expense
        final updatedExpense = ExpenseManagerService.getAllExpenses()
